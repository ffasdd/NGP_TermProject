...
ID2D1SolidColorBrush* UILayer::CreateBrush(D2D1::ColorF d2dColor, ID2D1SolidColorBrush* pTextBrush)
{
    m_pd2dDeviceContext->CreateSolidColorBrush(d2dColor, &pTextBrush);
...
void UILayer::Render(UINT nFrame)
{
    ...
    d2dcenter.x = 1920.0f - 240.0f;
    d2dcenter.y = 47.5f;
    D2D1_ELLIPSE d2dElipse = D2D1::Ellipse(d2dcenter, 15.0f, 15.0f);

    ID2D1SolidColorBrush* pd2dBrush = CreateBrush(D2D1::ColorF(D2D1::ColorF::Gold, 1.0f));
