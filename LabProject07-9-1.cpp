...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
	...
	HANDLE network_th;
	network_th = CreateThread(NULL, 0, ConnecttoServer, NULL, 0, NULL); // �α��� ������ 
	...
	while (1)
	{
		...
		else
		{
			...
			//	retval = send(clientsocket, (char*)&item_pack, sizeof(CS_ITEM_PACKET), 0);      // ������ �����մϴ�.
...
DWORD WINAPI ConnecttoServer(LPVOID arg)
{
	...
	while (true)
	{
		...
		if (Clients[0].c_id != -1 && Clients[1].c_id != -1 && Clients[2].c_id != -1)
		{
			...
			HANDLE recv_th;
			recv_th = CreateThread(NULL, 0, recvtoserver, (LPVOID)(clientsocket), 0, NULL);  // �α��� �Ϸ�� ������ ��� ������ ���� 
			break;
		}
