...
void CGameFramework::BuildObjects()
{
	...
	IDWriteTextFormat* pdwTextFormat = m_pUILayer->CreateTextFormat(L"���� ����", m_nWndClientHeight / 25.0f);
	...
	// pdwTextFormat = m_pUILayer->CreateTextFormat(L"���� ����", m_nWndClientHeight / 25.0f);
	...
	// �÷��̾� ��ġ�� �����ִ� �Լ��Դϴ�. SetPosition�� ���� XMFLOAT3���� �����ϸ� �÷��̾� ���� ��ġ�� �ٲ�ϴ�.
	// �� �÷��̾� ������ ���⼭ �غ���
